...
terminals_df = spark.read.format('delta').load(f"{lakehouse_path}/terminals").toPandas()
trucks_df    = spark.read.format('delta').load(f"{lakehouse_path}/trucks").toPandas()
trailers_df  = spark.read.format('delta').load(f"{lakehouse_path}/trailers").toPandas()
drivers_df   = spark.read.format('delta').load(f"{lakehouse_path}/drivers").toPandas()
customers_df = spark.read.format('delta').load(f"{lakehouse_path}/customers").toPandas()
routes_df    = spark.read.format('delta').load(f"{lakehouse_path}/routes").toPandas()
loads_df     = spark.read.format('delta').load(f"{lakehouse_path}/loads").toPandas()
trips_df     = spark.read.format('delta').load(f"{lakehouse_path}/trips").toPandas()
