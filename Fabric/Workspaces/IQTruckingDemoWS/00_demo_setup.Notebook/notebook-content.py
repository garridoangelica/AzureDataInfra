...
# 1. **Workspace ID and Name are optional** — if left blank, the notebook will automatically detect them from your current Fabric session. Only fill these in if you want to target a different workspace.
# 2. Download all workshop scripts, reference data, and the `TruckingSM.SemanticModel` files from GitHub into `./builtin/`
# 
