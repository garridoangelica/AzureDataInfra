...
LAKEHOUSE_NAME       = "lh_trucking"   # overridden by caller
WORKSPACE_NAME       = ""
...
# # full_tablename= f"`{WORKSPACE_NAME}`.{LAKEHOUSE_NAME}.{table_name}"
# print("=" * 60)
# print("TABLE ROW COUNTS")
# print("=" * 60)
# for table_name in LOAD_ORDER:
#     try:
#         count = spark.table(f"`{WORKSPACE_NAME}`.{LAKEHOUSE_NAME}.{table_name}").count()
